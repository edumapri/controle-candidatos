...
public class ProcessoSeletivo {
    ...
    static void entrandoEmContato(String candidato){
        ...
        if(atendeu){
            ...
            System.out.println("NÂO CONSEGUIMOS CONTATO COM " + candidato + ", NÚMERO MAXIMO TENTATIVAS " + tentativasRealizadas + " REALOIZADA");
        }
    }
    ...
    static void analisarCandidato(double salarioPretendido){
        ...
        if(salarioBase > salarioPretendido){
            ...
            System.out.println("AGURDO P RESULTADO DOS DEMAIS CANDIDATOS");
        }
    }
